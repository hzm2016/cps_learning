...
from ll4ma_movement_primitives.dmps import QuaternionDMP


class ContactQuaternionDMP(QuaternionDMP):
    """
    Contact-aware extension of Quaternion DMPs.
    ...
    def __init__(self, dmp_config, demos=[], phase=None, name="quaternion_dmp"):
        super(ContactQuaternionDMP, self).__init__(dmp_config, demos, phase, name)
        ...
        self.ts = ContactQuaternionTFSystem(dmp_config, demos)
